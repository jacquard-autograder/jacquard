...
public class Mob {
    ...
    private static int numHearts, numKidneys;
    ...
    public void takeDamage(int damage) {
        ...
        System.out.printf("The %s took %d %s of damage.%n", type, actualDamage, text);
    ...
    public void battle(Mob opponent) {
        ...
        System.out.printf("The %s won the battle!%n", winner);
    }
...
class Cow extends Mob {
    Cow() {
        super("cow", 5, Mob.Behavior.Passive, 0, 0);
    }
}
...
class Spider extends Mob {
    Spider() {
        super("spider", 15, Mob.Behavior.Neutral, 3, 8);
    }
}

class Zombie extends Mob {
    Zombie() {
        super("zombie", 20, Mob.Behavior.Hostile, 1, 4);
    }
}
