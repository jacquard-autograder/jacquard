 ...
 * dumped.
 */
public final class CoreTutorial5 {
     ...
     */
    public CoreTutorial5(final PrintStream out) {
        this.out = out;
    }

    private void runRunnable(MemoryClassLoader memoryClassLoader, Class<? extends Runnable> testClass) throws InstantiationException, IllegalAccessException {
        final Runnable testInstance = (Runnable) testClass.newInstance();
        testInstance.run();
    }

    private void runTest(MemoryClassLoader memoryClassLoader, Class<?>... testClasses) {
...
//        final Class<?> targetClass = memoryClassLoader.loadClass(cutName);
      ...
      //  runRunnable(memoryClassLoader, testClass);
        runTest(memoryClassLoader, testClass);
    ...
    public static void main(final String[] args) throws Exception {
        new CoreTutorial5(System.out).execute(
