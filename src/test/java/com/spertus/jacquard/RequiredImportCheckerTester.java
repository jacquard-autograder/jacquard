...
import com.spertus.jacquard.syntaxgrader.RequiredImportChecker;
import org.junit.jupiter.api.*;

import java.net.URISyntaxException;
import java.util.List;

public class RequiredImportCheckerTester {
    @BeforeAll
    ...
    public void fullMatch() throws URISyntaxException {
        RequiredImportChecker checker = new RequiredImportChecker(
